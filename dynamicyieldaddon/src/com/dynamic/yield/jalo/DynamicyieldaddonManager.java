...
/**
 * This is the extension manager of the Dynamicyieldaddon extension.
 */
public class DynamicyieldaddonManager extends GeneratedDynamicyieldaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DynamicyieldaddonManager.class.getName());
	 ...
	 */
	public static DynamicyieldaddonManager getInstance()
	{
		return (DynamicyieldaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				DynamicyieldaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DynamicyieldaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DynamicyieldaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of DynamicyieldaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of DynamicyieldaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
